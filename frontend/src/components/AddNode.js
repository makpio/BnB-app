  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          {" "}
          <Form.Item name="currentBestSol" label="Current Best Solution">
            <Input placeholder="Current Best Sol." value="currentBestSol" />
          </Form.Item>
          <Form.Item name="currentBestVar" label="Current Best Variables">
            <Input placeholder="Current Best Var." value="currentBestVar" />
          </Form.Item>
        </Form>
      </div>
    );
